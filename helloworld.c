...
<head>
    ...
    <title>SQL Easy Quiz | QuizMaster</title>
...
<body>
    ...
    <main class="container">
        <a href="sql-quizzes.html" class="back-btn">
        ...
        <div class="quiz-header">
            ...
            <h1>SQL Easy Quiz</h1>
            <p>Test your basic knowledge of SQL with this beginner-friendly quiz</p>
        </div>
        ...
        <div class="quiz-container">
            ...
            <div class="question-card">
                <div class="question-text">
                    ...
                    <span class="question">What does SQL stand for?</span>
                </div>

                <div class="options-container">
                    <div class="option" data-correct="false">
                        <span class="option-letter">A</span>
                        <span class="option-text">Structured Query Language</span>
                    </div>
                    ...
                    <div class="option" data-correct="false">
                        ...
                        <span class="option-text">Standard Query Language</span>
                    </div>
                    <div class="option" data-correct="false">
                        <span class="option-letter">D</span>
                        <span class="option-text">Sequential Query Language</span>
                    </div>
                </div>
                ...
                <div class="feedback incorrect-feedback">
                    ❌ Incorrect! The correct answer is B) Structured Query Language.
                </div>
            </div>
        ...
        <div class="quiz-container result-container">
            ...
            <div class="quiz-footer" style="justify-content: center;">
                <a href="sql-easy-quiz.html" class="btn" style="margin-right: 15px;">
                    <i class="fas fa-redo"></i> Try Again
                </a>
                <a href="sql-quizzes.html" class="btn">
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-column">
                    ...
                    <ul class="footer-links">
                        <li><a href="sql-easy-quiz.html">SQL Easy Quizzes</a></li>
                        <li><a href="sql-medium-quiz.html">SQL Medium Quizzes</a></li>
                        <li><a href="sql-hard-quiz.html">SQL Hard Quizzes</a></li>
                        <li><a href="sql-advanced-quiz.html">SQL Advanced Quizzes</a></li>
                    </ul>
                </div>
                <div class="footer-column">
                    <h3>Contact Us</h3>
        ...
        const questions = [
            {
                ...
                options: ["Structured Query Language", "Standard Query Language", "Sequential Query Language", "System Query Language"],
                correctAnswer: 0,
                explanation: "✅ Correct! SQL stands for Structured Query Language."
            },
            {
                question: "Which SQL command is used to retrieve data from a database?",
                options: ["SELECT", "INSERT", "UPDATE", "DELETE"],
                correctAnswer: 0,
                explanation: "✅ Correct! The SELECT command is used to retrieve data from a database."
            },
            {
                question: "What is the purpose of the WHERE clause in SQL?",
                options: ["To filter records", "To insert new records", "To update existing records", "To delete records"],
                correctAnswer: 0,
                explanation: "✅ Correct! The WHERE clause is used to filter records."
            },
            {
                question: "Which SQL command is used to insert new data into a database?",
                options: ["SELECT", "INSERT", "UPDATE", "DELETE"],
                correctAnswer: 1,
                explanation: "✅ Correct! The INSERT command is used to insert new data into a database."
            },
            {
                question: "What is the purpose of the ORDER BY clause in SQL?",
                options: ["To filter records", "To sort records", "To group records", "To join tables"],
                correctAnswer: 1,
                explanation: "✅ Correct! The ORDER BY clause is used to sort records."
            },
            {
                question: "Which SQL command is used to update existing data in a database?",
                options: ["SELECT", "INSERT", "UPDATE", "DELETE"],
                correctAnswer: 2,
                explanation: "✅ Correct! The UPDATE command is used to update existing data in a database."
            },
            {
                question: "What is the purpose of the JOIN clause in SQL?",
                options: ["To filter records", "To sort records", "To group records", "To combine rows from two or more tables"],
                correctAnswer: 3,
                explanation: "✅ Correct! The JOIN clause is used to combine rows from two or more tables."
            },
            {
                question: "Which SQL command is used to delete data from a database?",
                options: ["SELECT", "INSERT", "UPDATE", "DELETE"],
                correctAnswer: 3,
                explanation: "✅ Correct! The DELETE command is used to delete data from a database."
            },
            {
                question: "What is the purpose of the GROUP BY clause in SQL?",
                options: ["To filter records", "To sort records", "To group records", "To join tables"],
                correctAnswer: 2,
                explanation: "✅ Correct! The GROUP BY clause is used to group records."
            },
            {
                question: "Which SQL command is used to create a new table in a database?",
                options: ["CREATE TABLE", "INSERT TABLE", "UPDATE TABLE", "DELETE TABLE"],
                correctAnswer: 0,
                explanation: "✅ Correct! The CREATE TABLE command is used to create a new table in a database."
            }
        ];
